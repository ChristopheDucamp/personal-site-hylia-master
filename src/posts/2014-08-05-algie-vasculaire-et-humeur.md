...
La méchante bête est revenue me chahuter la tête la semaine dernière. Les premières sensations de douleurs sont apparues après consommation d'*un seul* petit verre de Bandol. Dans des circonstances dénuées de tout stress : dîner avec <span rel="friend colleague muse" class="microcard h-card">[Vincent](http://fr.linkedin.com/in/vinpindere)</span> sur la merveilleuse terrasse du Funiculaire de Saint Hilaire du Touvet après une journée délicieuse de vol libre...  
...
Chaque mal de tête semble avoir son "pattern". Le scénario de la montée de la douleur est le même. La *bête* neuronale n'hésite pas à harceler à tout moment : de jour comme en plein sommeil (réveil pas cool et les nuits sont courtes...). Ça ressemble à un orage. Sans traitement antidouleur, cela donne un premier "courant ascendant" entre cinq et quinze minutes avec une douleur de faible intensité. Suivi d'une phase intense : montée de douleur très rapide que je *rêverais de dessiner*. Durée : entre une et deux heures. Puis phase de descente pouvant se  diminuer ou s'éliminer avec le sommeil. 

![](algie-dessin-la-riboisiere.jpg "<small>Crédit Photo : La Riboisière - Bureau du Docteur <span class="h-card">Diana Concescu</span>)</small>")
...
![](http://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Imiject.jpg/220px-Imiject.jpg "Mais heureusement [il y a... l'Imiject](https://www.flickr.com/photos/christopheducamp/420924904/in/photolist-5njrmk-5ncDtL-5n8oBx-DcyRt-DcmiW/), la solution antidouleur radicale !") 

...
*Traduction d'un article original de <span class="p-author h-card">[Lauren Orsini](http://otakujournalist.com/about-the-author/)</span> publié le <time class="dt-published" value="2013-11-30">30 septembre 2013</time> pour ReadWriteWeb. Seul le <span class="p-name u-url">[lien original fait référence](http://readwrite.com/2013/09/30/understanding-github-a-journey-for-beginners-part-1)</span>.Je raffinerai au fil de la pratique de cet outil. [Seconde partie en cours d'étude](/github-pour-les-debutants-:-consignez-poussez-et-foncez-!/) pour me lancer dans les premiers *commits* à la ligne de commande. - <span class="u-syndication">[xtof](https://twitter.com/xtof_party/status/412238889739247616)</span>*

Note à moi-même du 3 juillet 2019 - vérifier les liens locaux (schéma URL cours de réaménagement pour les liens sur la partie 2. Et inversement.)
...
![image](/images/ma-page-github.jpg "ma première page github")
...
![image](/images/terminal-accueil-github.jpg "Ma fenêtre de Terminal")
...
![Image](/images/github-page-enregistrement.jpg "page d'enregistrement github.")
...
![image](/images/git-scm.com-pour-telecharger-git.jpg "http://git-scm.com/, l'endroit où vous téléchargez Git.")
...
![image](/images/terminal-config-git-nomutilisateur-email.jpg "Les toutes premières commandes de Git.")
...
![image](/images/github-creer-nouveau-repo.jpg 'Créer un nouveau repository sur GitHub'). 
...
![Créer un dépôt sur votre machine](/images/terminal-git-creer-repo.jpg "Créer un dépôt local Git en trois étapes.") 
...
Dans la [seconde partie](/github-pour-les-debutants-:-consignez-poussez-et-foncez-!/), vous apprendrez comment faire votre premier commit vers des dépôts locaux et sur Github. Et vous en saurez plus sur quelques ressources géniales de Github.

## Voir aussi 

* [GitHub pour les Débutants : Consignez, Poussez et Foncez](/github-pour-les-debutants-:-consignez-poussez-et-foncez-!/)
